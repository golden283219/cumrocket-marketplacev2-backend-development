...
SECRET_KEY = 'django-insecure-5(zjh7c-d%#s&)z7b4jzgr%=x_j&f2*wp%-#&v#b+_vy0i0xz9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.getenv('DEBUG', 'False') == 'True')

ALLOWED_HOSTS = ["api.cumrocket.io", "localhost", "cumrocket.io", "18.134.157.123"]
if DEBUG:
    ALLOWED_HOSTS += ["0.0.0.0"]

CORS_ALLOWED_ORIGINS = [
    "https://cumrocket.io",
    "https://api.cumrocket.io",
]
...
AWS_STORAGE_BUCKET_NAME = 'cumrocket-marketplacev2'
...
NFT_STORAGE = os.environ.get('NFT_STORAGE', None)
